...
class RepositoryManager:
    ...
    async def create_feature_branch(
        ...
        # Generate branch name: OrbitSpace/{project-id}-{feature-slug}-{timestamp}
        timestamp = datetime.utcnow().strftime('%Y%m%d-%H%M%S')
        branch_name = f"OrbitSpace/{project_id}-{feature_slug}-{timestamp}"
    ...
    async def commit_changes(
        ...
        full_message = f"""[OrbitSpace] {message}

Phase: {phase}
Project: {project_id}
Generated by Orbitspace OrbitSpace
"""
